...
# parameters['num_kernels'] = [100, 100, 100, 100] if type(opts.kernel_num) == str else map(lambda x: int(x),
#                                                                                           opts.kernel_num)
...
#     save_mappings(os.path.join(models_path, model_name, 'mappings.pkl'), word_to_id, char_to_id, tag_to_id, pt_to_id,
#                   dico_words, id_to_tag)
# else:
...
#                   kernels=parameters['kernels'], hidden_size=parameters['word_lstm_dim'],
